...
export function articleSchema(name: 'blogPost' | 'useCase', title: string, route: string) {
  return defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: `The /${route}/ URL. Keep this unchanged after publishing to preserve existing links.`,
